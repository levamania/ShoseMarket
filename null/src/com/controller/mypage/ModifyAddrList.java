...
public class ModifyAddrList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("addr", map); RequestDispatcher dispatcher =
		request.getRequestDispatcher("Content/mypage/modifyaddr.jsp");
